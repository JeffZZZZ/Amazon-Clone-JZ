...
const RegistrationForm = () => {
    ...
    const validateRegistration = () => {
        ...
        if(name === ""){
            ...
            setErrorUsername("Your name should contain letters and numbers only");
            isValidated=false;
        ...
        if(password === ""){
            ...
            setErrorPassword("Password should contain letters and numbers only");
            isValidated=false;
        ...
        <div className="registration">
            <div className="form-container">
                <form className="form" onSubmit={submitHandler}>
                    ...
                    <button className="registration-button" type="submit" >Create Your Amazon Account</button>
